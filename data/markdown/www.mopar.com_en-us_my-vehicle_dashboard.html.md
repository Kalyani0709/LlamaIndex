 Owner Vehicle Dashboard |Official Mopar Site
...
* Recommended Pages
* [Owner's Manual](/en-us/my-vehicle/owners-manual.html)
* [Warranty](/en-us/my-vehicle/warranty.html)
* [Schedule Service](/en-us/services.html)
* [Find Tires](/en-us/services/tire-services.html)
* [Remote Diagnostic Assistant](/en-us/remote-diagnostic.html)

![dashboard prom](/content/dam/mopar/images/dashboard/Subscription_ad_med.jpg)

Get Resources on the Go with the Branded Owner’s App!

[Learn More](/en-us/technology/mobile-app.html)

Contract Id:

![dashboard prom](/content/dam/mopar/MVP/new-hero/dashboard-mvp-banner.jpg)

To inquire about prepaid maintenance and other plans, call 1-866-818-9929

[Get a Quote](/en-us/care/mopar-vehicle-protection/plan-details.html)
...
Please enter your 4 digit PIN to send the remote command

Submit
TRY AGAIN

Disclaimer: Please click the Panic button again to deactivate.

### QUICK LINKS

---

* [VIN Lookup](/en-us/my-vehicle/vin-lookup.html)
* [Recall Search](/en-us/my-vehicle/recalls/search.html)
* [Special Offers](/en-us/service-coupons-and-offers.html)
* [Window Sticker](/en-us/my-vehicle/warranty.html)
* [Contact Us](/en-us/contact-us.html)
...
Your Custom Vehicle Dashboard
-----------------------------

Access available resources right at your fingertips with your custom dashboard. Want even more? Try adding a vehicle by VIN for an even more personalized experience.

[MANAGE GARAGE](/en-us/my-garage/select-vehicle.html)

YOUR CUSTOM VEHICLE DASHBOARD
-----------------------------

Make the most of your personalized dashboard and discover the many valuable resources available right at your fingertips by adding a vehicle to your garage.
...
* Know your vehicle inside and out with its owner's manual, warranty and more
* Set your preferred dealer and book service appointments with a few simple clicks
* Keep current with a snapshot of your past maintenance records, all in one place

#### STAY CONNECTED

* Manage all your connected car subscriptions to keep you free of interruptions
* Start your car, flash your lights and more using your preferred device
* Check your vehicle’s health+ and performance stats++ so your adventures never stop

#### MAKE IT YOURS

* Manage any Chrysler,Jeep,Dodge,Ram and FIAT brand vehicle in your garage
* Upload a picture of your vehicle from your laptop, smartphone or tablet
* Personalise your experience even more with a nickname for each vehicle you own

+Requires an active SiriusXM Guardian or Uconnect Access subscription   
 ++Select SRT vehicles only with an active SiriusXM Guardian or Uconnect Access subscription

Make It Personal By Registering Today
-------------------------------------

Once you’re signed in, you can access personalized vehicle resources, connect with your preferred dealer, keep up-to-date with your vehicle’s service history—and much more—with an online experience all your own.
...
Access monthly health reports to make sure your vehicle is running at peak performance\*

#### MAINTENANCE SCHEDULE

Keep track of your vehicle's maintenance schedule with reminders of upcoming service requirements

#### SCHEDULE SERVICE

Make an appointment with your preferred dealership when your vehicle is in need of service

#### MAINTENANCE REPORTS

Look up past service records for your vehicle,all in one place
...
Access your personalised dashboard anytime, anywhere. Simply sign in or register to schedule service with your preferred dealer, view your maintenance records, and discover all the other resources right at your fingertips - all in one spot and tailored to you.   
   
 Don’t have an account with us yet? [Register Now](/en-us/sign-in.html)
...
* ![](/content/dam/mopar/images/offers/SWX-Shell-Rewards-without-logo_sm.jpg)

  ### Fuel Rewards logoEXCLUSIVE SAVINGS FOR CONNECTED SERVICES SUBSCRIBERS

  Sign up for the Fuel Rewards® Program or link your existing account for fuel savings. Terms apply.

  [Learn More](https://join.fuelrewards.com/frconnect/registration?partSrcId=stellantis)
* ![](/content/dam/mopar/logos/redesign/banner/Guest-banner-lrg.jpg)

  ### EARN 5X POINTS ON ALL Mopar® SERVICE, PARTS AND ACCESSORIES—EVERY DAY

  With the DrivePlusSM Mastercard®, you will earn 5X Points on all Mopar® purchases—including service, parts and accessories. Use your DrivePlusSM Mastercard® for gas and travel purchases and earn 2X Points back, too. Ready to earn rewards?   
  Learn more about this great opportunity today.

  [Learn More](/en-us/savings/mastercard.html)
* ![](/content/dam/mopar/logos/redesign/banner/mastercard_banner_sm.jpg)
  ...
  Your Current Mastercard In-Dealer Cash Valueas of dateReported
...
Get to know your vehicle inside and out - including an overview of select features, vehicle operation, and more - with our library of helpful videos.

[View All](/en-us/care/owners-manual/videos.html)
...
Stellantis '25 Everyday Offer
  
Restrictions apply. Offer valid from February 12, 2025, through February 11, 2026 (the "Offer Period"). Earn 08¢/gal (the "Everyday Reward") when you (i) join the program as a new member or link to your existing Fuel Rewards® account at https://join.fuelrewards.com/frconnect/registration?partSrcId=stellantis during the Offer Period and are (ii) a user of any of the following: Alfa Connect, Chrysler Connect, Dodge Connect, Jeep Connect, Ram Connect, Fiat Connect. The Everyday Reward earned during the Offer Period can be redeemed up to 5 times per calendar month. To redeem this Everyday Reward, swipe your Fuel Rewards® card, a linked payment card or enter your Alt ID and complete your first fill-up at a participating Shell station. The Everyday Reward will be available for instant use in your Fuel Rewards® account upon registration or linking and expires February 1, 2026.
...
See <https://www.fuelrewards.com/fuelrewards/how> for more details.
