...
Lemon Law, Warranty and Repair Assistance for Chrysler, Dodge, Jeep, Ram, SRT, FIAT & Alfa Romeo vehicles

Both FCA US LLC and your local dealer are dedicated to delivering exceptional service and complete owner satisfaction. Our commitment starts the moment you purchase your Chrysler, Dodge, Jeep®, Ram, SRT®, FIAT® or Alfa Romeo vehicle. Whether you're dealing with regular maintenance, a warranty repair, or even a lemon law issue - your local dealer is here to help you.

[Locate Nearest Dealer](/en-us/services/find-dealer.html)

Attention California residents:  
California Song-Beverly “Lemon Law” Notice

Effective July 1, 2025, California residents must submit notice to FCA at least 30 days prior to the commencement of an action seeking civil penalties under subdivision © of Section 1794 of the Civil Code. Notices pursuant to the Song-Beverly Consumer Warranty Act, containing an accurate Vehicle Identification Number ("VIN”) of the motor vehicle, and a brief summary of the repair history and problems with the motor vehicle should be emailed to  [warrantynotice@stellantis.com.](mailto:warrantynotice@stellantis.coml)

If, however a situation arises that your local dealer management cannot satisfy, we ask that you contact us so that we can work with you directly. Please follow the steps below to ensure the quickest resolution.
...
![Vehicle Inspection](/content/dam/mopar/images/expressLane/mopar_express-lane_default-diagram-modal_exterior-checkup_image.jpg)

Under Hood Checkup
------------------

![Vehicle Inspection](/content/dam/mopar/images/expressLane/mopar_express-lane_default-diagram-modal_under-hood_image.jpg)

Under Vehicle Checkup
---------------------

![Vehicle Inspection](/content/dam/mopar/images/expressLane/mopar_express-lane_default-diagram-modal_under-vehicle-checkup_image.jpg)
...
[1-800-334-9200](tel:18003349200)

Step 3

If your concern has not been resolved to your satisfaction, you can submit the matter to the
National Center for Dispute Settlement, LLC (NCDS). NCDS is an independent company that provides
expedited arbitration services at no cost to you.

NCDS will review the facts, inspect your vehicle if appropriate, and render a decision. FCA agrees
to be bound by the decision; the decision is binding on you only if you choose to accept it.

To learn more, visit the [NCDS website](https://www.ncdsusa.org),
or call NCDS at [1-866-662-4639](tel:18666624639).
