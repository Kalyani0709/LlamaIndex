 Online Scheduling Service Near You | Official Mopar® Site
...
![](/content/dam/mopar/images/oss-plus/OSS/Hero_lrg@2x.jpg)

YOU ARE SCHEDULING AN APPOINTMENT WITH:
---------------------------------------

[SCHEDULE SERVICE NOW](#oss-spi)

#### Here's How to Find Your Vin

##### What is a VIN?

A VIN is a Vehicle Identification Number. It is a 17-character alphanumeric identifier or a manufacturer’s serial number. Each
character in the VIN number has a significant meaning. Together, they create a number that provides information about the
vehicle and its unique history.
...
![](/content/dam/mopar/images/global/registration_search_vin_image_lrg.jpg)
...
Oops! Something went wrong while fetching the coupons!
...
don't hesitate to [contact us](/en-us/care/mopar-vehicle-protection/contact.html).

How do I schedule a service appointment?

To schedule a service appointment online, start by selecting a dealer that supports online service scheduling (OSS) and click the "Book Now" button

Why can't I use online service scheduling (OSS)?

Some dealers do not support OSS. If you have selected a dealer that doesn't support OSS, you will need to call the dealer directly to make a service appointment or select a different dealer.

How do I find a dealer that supports online service scheduling?

Using the Find a Dealer search, look for dealers with the "Online Scheduling Available" label.

What if my dealer doesn't support online service scheduling?
...
If so, please click below first to select a certified dealer, which is required for EV service. Otherwise, you may continue booking your appointment.

[Find a Certified EV Dealer](#)
[Continue Scheduling](/en-us/service-maintenance/online-scheduling-service/schedule-an-appointment.html)

Locate a nearby dealership

Tell us which Online Service Scheduling Dealer is right for you.
