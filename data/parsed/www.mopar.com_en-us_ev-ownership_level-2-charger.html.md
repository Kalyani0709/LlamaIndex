...
The Free2move Charge Level 2 charging stations are available in either 40 amp or 48 amp and can deliver a full charge up to six times faster than a Level 1 charging unit. The available charging systems hold a coveted ENERGY STAR® Certification, and are compact, lightweight. The 40A charging station can accommodate either plug-in or hardwired installation. The 48A charges 20% faster than the 40A Level 2 charging station.

# 40AMP home charging station

Upgrade to a Free2move Charge 40A home charging station which accommodates either plug-in or hardwired installation, and charge your vehicle even faster.

- UP TO SIX TIMES FASTER CHARGING THAN LEVEL 1 CHARGING.
- ENERGY STAR® CERTIFIED.
- EASY TO USE AND INSTALL: Small lightweight, easy to mount unit accommodates either plug-in or hardwired installation and is weatherproof for indoor/outdoor charging.
- RELIABLE: Assembled in the USA and backed by outstanding customer service.
- Potentially qualifies for the 30% Federal Tax Credit (up to $1,000) for equipment and installation. May require vehicle purchase; consult your tax professional for more information.

40AMP Charger
Buy Now Specifications

# 48AMP home charging station

Upgrade to a Free2move Charge 48A home charging station and charge your vehicle 20% faster than with a 40A charger.

- CHARGE UP TO SIX TIMES FASTER THAN LEVEL 1 CHARGING AND UP TO 20% FASTER THAN 40A LEVEL 2 CHARGING.
- ENERGY STAR® CERTIFIED.
- ASSEMBLED IN THE USA.
- REQUIRES HARDWIRED INSTALLATION.
- EASY-TO-USE QUICK-RELEASE MOUNT IS WEATHERPROOF FOR EITHER INDOOR OR OUTDOOR INSTALLATION AND FEATURES A 25-FOOT CABLE.
- UNIT IS COMPATIBLE WITH BOTH BATTERY ELECTRIC VEHICLES AND PLUG-IN HYBRID ELECTRIC VEHICLES.
- POTENTIALLY QUALIFIES FOR 30% FEDERAL TAX CREDIT FOR EQUIPMENT AND INSTALLATION. MAY REQUIRE VEHICLE PURCHASE; CONSULT YOUR TAX PROFESSIONAL FOR MORE INFORMATION.

48AMP Charger
Buy Now Specifications

# FREE2MOVE CHARGE LEVEL 2 48A CHARGING STATION

82219081AA

# Specifications

| Charging Power         | 48 amp (11.5 kW)                                                                                                                         |
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| Product Dimensions     | 7.8L x 7.9W x 3.9D (Inches)                                                                                                              |
| Product Weight         | 18.4 lbs                                                                                                                                 |
| Hardwired Installation | Charging station requires hardwired installation into the home electrical panel by a licensed electrician. Installation is not included. |
| Warranty               | 3-Year Limited Product Warranty (Parts Only)                                                                                             |
...
# FREE2MOVE CHARGE LEVEL 2 40A CHARGING STATION

# 82219081AA

# Specifications

| Charging Power              | 40 Amp (9.6 kW)                                                                                            |
| --------------------------- | ---------------------------------------------------------------------------------------------------------- |
| Product Dimensions          | 7.8L x 7.9 Inches W x 3.9 Inches D                                                                         |
| Product Weight              | 18.4 lbs                                                                                                   |
| Installation Plug-In        | 2.3ft with NEMA 14-50 Plug                                                                                 |
| Installation if Hard-Wiring | Remove plug to allow for hardwiring into wall                                                              |
| Supply Circuit              | 220V                                                                                                       |
| Warranty                    | 3-Year Limited Product Warranty (Parts Only)                                                               |
| Safety                      | UL and cUL NOM                                                                                             |
| Charger Cable Length        | 25-feet                                                                                                    |
| Vehicle Connector Type      | J1772 Standard Compliant                                                                                   |
| Enclosure                   | 1. Dynamic LED Lights
2. Integrated Cable Management
3. Includes NEMA 14-50 plug but can also be handwired |
| Environment Rating          | Indoor / Outdoor                                                                                           |
| Operating Temperature       | -40°F to 140°F (-40°C to 60°C)                                                                             |
| Codes & Standards           | FCC and IC compliant                                                                                       |
| Country of Origin           | Assembled in USA using domestic and imported parts                                                         |
