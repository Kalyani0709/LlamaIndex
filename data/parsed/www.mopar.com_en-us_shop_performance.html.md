...
# Crate HEMI® Engine Kit Parts Explained

Mopar® now offers five Crate HEMI® engines that let you turn any pre-1976 classic into a legend. Take yours to the next level with a Crate HEMI Engine and “plug and play” kit.

Shop Now
Learn More

# Jeep® Brand Performance Parts

Hardcore off-roaders require hardcore parts—so that’s what we’ve engineered. Each part has been specifically designed, built and quality-tested to elevate your ride to an entirely new level of performance.
...
Open on a smoky scene with a muscle car that has its engine revving. Behind the car mostly covered in smoke an elephant is seen walking up, with elephant trumpeting noises and sounds of footsteps stomping. The scene cuts to a black asphalt background as the Hellephant engine revs then fades into a low engine gurgle, and the super comes on screen “There’s a 1,000 hp Hellephant in the room”. The engine flies into the scene replacing the first super, as the second super “Bring it into your garage” fades in over top, engine noise still running in background. Cut to the next super “pre‐order now” on the same asphalt background, followed immediately by another cut to the next super “visit cratehemi.com. As we hear the engine rev one final time we see the Hellephant logo and hashtags #hellephant and #hemiday transitioning into the Mopar logo with cratehemi.com and hear the engine fade away. A disclaimer is shown at the bottom of the screen: “Copyright 2019 FCA US LLC. All Rights Reserved. Mopar and HEMI are registered trademarks of FCA US LLC.”

# Explore our new estore
